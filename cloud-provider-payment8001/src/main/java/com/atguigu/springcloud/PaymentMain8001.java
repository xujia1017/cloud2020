...
/**
 * 微服务提供者——支付module模块
 * Eureka Client端，将支付服务模块注册进Eureka Sever，成为服务提供者provider
 *
 ...
 *        我们可以通过 basePackages 等属性指定 @ComponentScan 自动扫描的范围，如果不指定，则默认Spring框架实现从声明 @ComponentScan
 *        所在类的package进行扫描，默认情况下是不指定的，所以SpringBoot的启动类最好放在root package下。
 *
 ...
 */
@SpringBootApplication  //SpringBoot的主配置类，Spring Boot会运行这个类的main方法来启动SpringBoot应用
